...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  getCommunityRuntime: () => invoke('hermes:community:runtime'),
  startCommunityRuntime: () => invoke('hermes:community:start'),
  communityApi: (path, init) => invoke('hermes:community:api', path, init),
